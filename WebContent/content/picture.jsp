	 ...
	 <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.waterfall').infinitescroll({
                navSelector: "#navigation-pic", //导航的选择器，会被隐藏
                nextSelector: "#navigation-pic a", //包含下一页链接的选择器
                itemSelector: ".picture", //你将要取回的选项(内容块)
                debug: true, //启用调试信息
						...
						<div class="collapse navbar-collapse " id="navbar-collapse">
							<div class="header-nav">
								<ul class="nav navbar-nav">
									...
									<li class="active"><a href="picture.html">图像</a></li>
		...
		<!-- <div class="container index-backcolor">
			<div class="row col-lg-10 col-lg-offset-1"> -->
				<div class="waterfall">
					...
					<div class="picture">     
					      <a class="example-image-link" href="http://lokeshdhakar.com/projects/lightbox2/images/image-2.jpg" data-lightbox="example-2" data-title="XXX"><img class="example-image" src="http://lokeshdhakar.com/projects/lightbox2/images/thumb-2.jpg" alt="image-1"/></a>
...
<div id="navigation-pic"><a href="page.php?page=1"></a></div>
					        ...
					        <div class="row">
					            ...
					            <section>
					                <div class="col-lg-6 col-lg-offset-2">
					                    ...
					                    <form id="rgsForm" method="post" class="form-horizontal" action="#">
